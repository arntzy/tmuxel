...
silent only
cd ~/thesis/tmuxgraphics
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +3 tmuxgraphics.sh
badd +1 tmuxels.py
badd +1 pyxel.py
args tmuxgraphics.sh
edit tmuxgraphics.sh
...
silent! normal! zE
let s:l = 79 - ((23 * winheight(0) + 13) / 27)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((6 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
